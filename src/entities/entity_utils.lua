...
function EntityUtils.getDistanceSquared(a, b)
   local aCenter = EntityUtils.getEntityCenter(a)
   local bCenter = EntityUtils.getEntityCenter(b)
...
function EntityUtils.getEntityCenter(entity)
...
function EntityUtils.pointIsInsideCircle(x, y, circle)
...
function EntityUtils.pointIsInsideRectangle(x, y, rectangle)
...
function EntityUtils.pointIsInsideEntity(x, y, entity)
   if entity.visual == "circle" then
      return EntityUtils.pointIsInsideCircle(x, y, entity)
   elseif entity.visual == "rectangle" then
      return EntityUtils.pointIsInsideRectangle(x, y, entity)
   end
   return false
end
